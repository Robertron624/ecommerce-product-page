...
const AddToCartButton = () => {
  return (
        ...
        <button className={`shadow-sm shadow-orange mb-16 md:mb-0 cursor-pointer rounded-md py-3 w-11/12 bg-orange justify-center mt-5 font-bold flex gap-4 ${styles.add_to_cart_btn}`}>
